                ...
                ft.Container(
                    content=ft.Stack(
                        controls=[
                            ...
                            ft.Container(
                                content=ft.Text("5", style=ft.TextStyle(font_family="digital-7",size=20), ref=qnum_value_ref),
                                alignment=ft.alignment.top_left,
                                left=370,
                                top=140,
                            ),
                            ...
                            ft.Container(
                                content=ft.Text("05", style=ft.TextStyle(font_family="digital-7", size=60), ref=round_value_ref),
                                alignment=ft.alignment.top_left,
                                left=80,
                                top=400,
                            ),
                    ...
                    content = ft.Card(
                        content=ft.Container(
                            content=ft.Stack(
                                controls=[
                                    ft.Container(
                                        content=ft.Text("ROUND 5: DECIPHER", size=15, weight=ft.FontWeight.BOLD, text_align=ft.TextAlign.CENTER),
                                        left=0,
                                        top=10,
                                        width=930,
                                    ),
